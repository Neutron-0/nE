  ...
  if (filteredTracks.length === 0) {
    return (
      <div className="p-12 text-center text-zinc-500">
        <Music className="w-12 h-12 mx-auto mb-3 text-zinc-800 stroke-1" />
        <h3 className="text-lg font-bold text-zinc-400">No tracks found</h3>
        <p className="text-xs text-zinc-600 mt-1">Add audio files to your library and scan</p>
      </div>
    )
  }
  ...
  return (
    <div className="p-6 md:p-8 space-y-6">
      <div className="flex items-center justify-between px-1">
        ...
        <span className="text-xs text-zinc-500 font-hud">{filteredTracks.length} tracks</span>
      </div>
