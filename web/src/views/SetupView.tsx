...
export const SetupView: React.FC<SetupViewProps> = ({ onBackToLogin }) => {
  ...
  return (
    <div className="min-h-screen bg-[#121110] flex flex-col items-center justify-center p-6 text-zinc-200 select-none">
      ...
      <div className="absolute w-[500px] h-[500px] bg-amber-600/5 rounded-full blur-3xl pointer-events-none" />
      ...
      >
        ...
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <p className="text-xs text-zinc-400 mt-1">Configure root administrator credentials</p>
        </div>
