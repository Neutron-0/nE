  ...
  return (
    <div className="p-6 md:p-8 space-y-6">
      ...
      <div className="flex items-center gap-5 pb-6 border-b border-white/5">
        <div className="w-16 h-16 rounded-[22px] bg-[#221f1c] border border-white/10 flex items-center justify-center text-rose-500 shadow-xl">
        ...
        <div>
          ...
          <p className="text-xs text-zinc-400 mt-1 font-hud">{tracks.length} favorites</p>
        </div>
      </div>
